class Out {
  ...
  // Preset messages
  public void msgErr() { System.out.println(RED + ITALIC + "[ERROR] Something went wrong..." + RESET); }
  public void msgInv (String msg) { System.out.println(RED + ITALIC + "[UH OH!]" + RESET + PINK + msg + RESET); }
